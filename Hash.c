...
int codigo2(char *c){
    if(strcmp(c,"â")==0) return 2;
    else if(strcmp(c,"ã")==0) return 2;
    else if(strcmp(c,"á")==0) return 2;
    else if(strcmp(c,"à")==0) return 2;
    else if(strcmp(c,"ç")==0) return 2;
    else if(strcmp(c,"é")==0) return 3;
    else if(strcmp(c,"í")==0) return 4;
    else if(strcmp(c,"õ")==0) return 6;
    else if(strcmp(c,"ô")==0) return 6;
    else if(strcmp(c,"Â")==0) return 2;
    else if(strcmp(c,"Ã")==0) return 2;
    else if(strcmp(c,"Á")==0) return 2;
    else if(strcmp(c,"À")==0) return 2;
    else if(strcmp(c,"Ç")==0) return 2;
...
void imprimir(long long unsigned int h){
    ...
    if(hashtmp>1000000) hashtmp=clean(hashtmp);
    //printf("%llu\n",hashtmp);
    hashtmp = hashtmp%M;
    link t;
    int continuar=0;
